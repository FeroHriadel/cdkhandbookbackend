  ...
  return (
    <div className='w-[100%]'>
      ...
      <Container>
        ...
        <Logo className='mb-2' />
        <p className='text-center'>Welcome to ThisSite, your ultimate platform for showcasing your creativity and organizing your unique items. Whether you're a collector, artist, or enthusiast, our intuitive interface allows you to create, categorize, and share your personalized collections effortlessly.</p><br /><br />
